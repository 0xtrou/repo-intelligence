...
target repo's own test/tooling code (no Maestro flows, no Playwright specs for targets).
...
4. **Nothing target-specific gets hard-coded here** — the toolkit must stay generic.
